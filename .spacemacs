...
(custom-set-faces
 ...
 '(ediff-fine-diff-A ((t (:background "brown" :weight bold))))
 '(ediff-fine-diff-Ancestor ((t (:background "dark green" :weight bold))))
 '(ediff-fine-diff-B ((t (:background "dark cyan" :weight bold))))
 '(ediff-fine-diff-C ((t (:background "dark blue" :weight bold)))))
